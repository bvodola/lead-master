              ...
              <KeyLogger>
                ...
                <div style={style.content}>
                  <Switch>
                    ...
                    <Route
                      path="/clients/edit/:_id"
                      render={({ match }) => <SaveClient clientId={match.params._id} />}
                    />
                    <Route
                      exact
                      path="/clients"
                      render={() => <Clients setAppState={this.setState.bind(this)} />}
                    />
                    <Route
                      path="/documents-form/:_id?"
                      render={({ match }) => <DocumentsForm clientId={match.params._id} />}
                    />
                    <Route path="/playground" component={Playground} />
                    <Route
                      path="/save-task"
                      render={() => <SaveTask currentUser={currentUser} />}
                    />
                    <Route
                      path="/kanban"
                      render={() => <Kanban kanban={kanban} onDragEnd={this.updateKanban} />}
                    />
                    <Redirect to="/clients" />
                  </Switch>
                </div>
